...
//
/*Given an array of numbers, remove numbers from the end of the array until it's empty. With each number, if it's bigger than 100 log
  that it's a big number to the console. Otherwise log that it's a small number to the console.*/
...
while (numArray >= [0]/* your code here */) {
    ...
    if (removedNum > 100/* your code here, use removedNum */) {
     ...
     console.log(`${removedNum} is a small number`)   //add the appropriate console.log() statement here
    }
}
